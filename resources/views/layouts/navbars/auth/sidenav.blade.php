<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ in_array(Route::currentRouteName(), ['setAdmin', 'detailsAdmin', 'editAdmin']) ? 'active' : '' }}"
                    href="{{ route('setAdmin') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-tv-2 text-info text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Setting Admin</span>
                </a>
            </li> --}}
            <li class="nav-item">
    ...
    {{-- <div class="sidenav-footer mx-3 ">
        ...
        {{-- <a class="btn btn-info btn-sm mb-0 w-100"
