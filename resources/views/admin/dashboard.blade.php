                        ...
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder">
                                    {{ $totalAntrian }} @if ($totalAntrian == 0)
                                    - Kosong
                                    @endif
                                </h5>
                            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Jumlah Doktor</p>
                                <h5 class="font-weight-bolder">
                                    {{ $totalDoctor }} @if($totalDoctor == 0) {
                                    - Kosong
                                    } @endif
                                </h5>
                            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Traffic Website</p>
                                <h5 class="font-weight-bolder">
                                    $103,430
                                </h5>
                            </div>
        ...
        <div class="col-lg-7 mb-lg-0 mb-4">
            <div class="card z-index-2 h-100">
                <div class="card-header pb-0 pt-3 bg-transparent">
                    <h6 class="text-capitalize">User Register</h6>
                        ...
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <h6 class="mb-1 text-dark text-sm">{{ $patient->antrian }} - {{
                                        $patient->poly->nama }}
                                    </h6>
                                    <span class="text-xs font-weight-bold">ID : {{ $patient->id }} | {{
